...
#include <uchar.h>
	...
	/* Game */
	QSP_LEGACY_EXTERN QSP_BOOL QSPLoadGameWorldFromFile(const QSP_CHAR *fullPath, QSP_BOOL isAddLocs);
	QSP_LEGACY_EXTERN QSP_BOOL QSPLoadGameWorldFromData(const char *data, int dataSize, QSP_BOOL isAddLocs);
